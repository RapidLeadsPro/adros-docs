---
title: Dashboard & frontend integration
description: Dashboard routes and backend alignment for Adros. Command Center, Strategy Workspace, Files on R2, Campaigns, CEO — API expectations (verify on your deploy).
---
...
7. **API Keys** — `client/src/pages/ApiKeys.tsx` (`/api-keys`)
