...
> **Pattern (external stack):** the operator may work through an **optional** orchestration layer (Paperclip/OpenClaw/custom). That layer routes; Adros is the marketing brain and execution plane. Research lanes (Perplexity, Manus, or custom) feed findings back; the task ledger (Paperclip or equivalent) tracks state when you use one.
>
