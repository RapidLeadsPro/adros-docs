...
description: Common questions, setup mistakes, and the foot-guns we've seen people hit. The fastest way to unstick yourself.
---
...
- **Check the [Technical Overview](/integrations/overview)** — every known foot-gun is documented in section 11
- **Check the [Integration Notes](/integrations/integration-notes)** — architectural blind spots for anyone wiring Adros into orchestration
